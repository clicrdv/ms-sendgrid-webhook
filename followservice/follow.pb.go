...
type ClicRdvFollowMailServiceClient interface {
	SendMail(ctx context.Context, in *ClicRdvFollowMail, opts ...grpc.CallOption) (*SendMailStatus, error)
}
...
func (c *clicRdvFollowMailServiceClient) SendMail(ctx context.Context, in *ClicRdvFollowMail, opts ...grpc.CallOption) (*SendMailStatus, error) {
	out := new(SendMailStatus)
	err := grpc.Invoke(ctx, "/followmailservice.ClicRdvFollowMailService/SendMail", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ClicRdvFollowMailServiceServer interface {
	SendMail(context.Context, *ClicRdvFollowMail) (*SendMailStatus, error)
}
...
func _ClicRdvFollowMailService_SendMail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ClicRdvFollowMail)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClicRdvFollowMailServiceServer).SendMail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/followmailservice.ClicRdvFollowMailService/SendMail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClicRdvFollowMailServiceServer).SendMail(ctx, req.(*ClicRdvFollowMail))
	}
...
var _ClicRdvFollowMailService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SendMail",
			Handler:    _ClicRdvFollowMailService_SendMail_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	0xe5, 0x19, 0x15, 0x72, 0x49, 0x60, 0xb8, 0x2c, 0x18, 0xe2, 0x6a, 0xa1, 0x50, 0x2e, 0x0e, 0x98,
	0x29, 0x42, 0x2a, 0x7a, 0x18, 0xbe, 0xd2, 0xc3, 0xd0, 0x28, 0xa5, 0x88, 0x45, 0x15, 0xaa, 0x43,
	0x94, 0x18, 0x9c, 0xec, 0xb9, 0x64, 0x92, 0x73, 0x32, 0x93, 0x8b, 0x52, 0xca, 0xf4, 0x32, 0xf3,
	0x31, 0x35, 0x38, 0xc9, 0xe2, 0x72, 0x50, 0x00, 0x28, 0x78, 0x03, 0x18, 0x93, 0xd8, 0xc0, 0xe1,
	0x6c, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x83, 0x82, 0x7c, 0x34, 0x77, 0x01, 0x00, 0x00,
}
